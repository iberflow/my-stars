...
- [kaptinlin/jsonschema](https://github.com/kaptinlin/jsonschema) - Go library for JSON Schema Draft 2020-12 validation with enhanced outputs and multilingual error messages
...
- [hupe1980/go-tiktoken](https://github.com/hupe1980/go-tiktoken) - ✂️  OpenAI's tiktoken tokenizer written in Go
...
- [eas4ai/go-repomap](https://github.com/eas4ai/go-repomap) - Go package to produce a repomap based on tree-sitter
...
- [Kardbord/hfgo](https://github.com/Kardbord/hfgo) - An unofficial Go SDK for the Hugging Face Inference API.
...
- [daulet/tokenizers](https://github.com/daulet/tokenizers) - Go, Wasm bindings for HF Tokenizers and Tiktoken
...
- [madtyping/keyboard-localizations](https://github.com/madtyping/keyboard-localizations) - 
